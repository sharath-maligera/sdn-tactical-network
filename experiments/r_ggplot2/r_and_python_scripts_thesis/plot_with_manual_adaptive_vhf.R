...
data_df_1$shaping <- "Without \nAdaptive Shaping"
data_df_1_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h2_data_9_6_kbps.csv')
data_df_1_1$data_rate <- "9.6 kbps"
data_df_1_1$shaping <- "With \nAdaptive Shaping"
...
data_df_2$shaping <- "Without \nAdaptive Shaping"
data_df_2_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h2_data_4_8_kbps.csv')
data_df_2_1$data_rate <- "4.8 kbps"
data_df_2_1$shaping <- "With \nAdaptive Shaping"
...
data_df_3$shaping <- "Without \nAdaptive Shaping"
data_df_3_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h2_data_2_4_kbps.csv')
data_df_3_1$data_rate <- "2.4 kbps"
data_df_3_1$shaping <- "With \nAdaptive Shaping"
...
data_df_4$shaping <- "Without \nAdaptive Shaping"
data_df_4_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h2_data_1_2_kbps.csv')
data_df_4_1$data_rate <- "1.2 kbps"
data_df_4_1$shaping <- "With \nAdaptive Shaping"
...
data_df_5$shaping <- "Without \nAdaptive Shaping"
data_df_5_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h2_data_0_6_kbps.csv')
data_df_5_1$data_rate <- "0.6 kbps"
data_df_5_1$shaping <- "With \nAdaptive Shaping"
...
gg <- gg + facet_grid( factor(shaping, levels=c('Without \nAdaptive Shaping','With \nAdaptive Shaping')) ~ factor(data_rate, levels=c('0.6 kbps','1.2 kbps','2.4 kbps','4.8 kbps','9.6 kbps')), scales = "free")
...
ggsave(filename = "C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/plots/manual_adaptive_shaping_ets_vhf.png",plot=last_plot(), device="png", units = "mm", width = 400, height = 200, dpi = 600)
#ggsave(filename = "C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/thesis_plots/host_h2_ets_manual_adaptive_shaping.eps",plot=last_plot(), device="eps", units = "mm", width = 400, height = 220, dpi = 600)
