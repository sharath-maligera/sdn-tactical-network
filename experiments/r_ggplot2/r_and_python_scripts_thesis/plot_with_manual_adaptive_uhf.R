...
data_df_1_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h3_data_240_kbps.csv')
...
data_df_2_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h3_data_120_kbps.csv')
...
data_df_3_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h3_data_60_kbps.csv')
...
data_df_4_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h3_data_30_kbps.csv')
...
data_df_5_1 <- read.csv(file = 'C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/data/adaptive_meter_manual_ETS/h3_data_15_kbps.csv')
...
gg <- gg + facet_grid( factor(shaping, levels=c('Without \nAdaptive Shaping','With \nAdaptive Shaping')) ~ factor(data_rate, levels=c('15 kbps','30 kbps','60 kbps','120 kbps','240 kbps')), scales = "free")
...
ggsave(filename = "C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/thesis_plots/host_h3_ets_manual_adaptive_shaping.eps",plot=last_plot(), device="eps", units = "mm", width = 400, height = 220, dpi = 600)
