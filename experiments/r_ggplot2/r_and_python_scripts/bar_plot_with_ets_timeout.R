...
gg1 <- gg1 + scale_fill_manual(values=c('#c74d4c','#aaa2a4'))
...
gg2 <- gg2 + scale_fill_manual(values=c('#c74d4c','#aaa2a4'))
...
gg3 <- gg3 + scale_fill_manual(values=c('#c74d4c','#aaa2a4'))
...
gg4 <- gg4 + scale_fill_manual(values=c('#c74d4c','#aaa2a4'))
...
gg5 <- gg5 + scale_fill_manual(values=c('#c74d4c','#aaa2a4'))
