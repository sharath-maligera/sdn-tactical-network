...
class Switches4HostsTopo(Topo):
    ...
    def __init__(self, **opts):
        ...
        # 100 Mbps
        self.addLink(host0, switch0, bw=1) # s0.port_1: host0
        self.addLink(host1, switch0, bw=1) # s0.port_2: host1

        self.addLink(host2, switch0, bw=1) # s1.port_1: host0
        self.addLink(host3, switch0, bw=1) # s1.port_1: host0
