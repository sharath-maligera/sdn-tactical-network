...
def myNet():
    ...
    h1.cmd('/sbin/tc qdisc add dev h1-eth0 root handle 1: htb default 11 && '
           '/sbin/tc class add dev h1-eth0 parent 1: classid 1:1 htb rate 250kbps ceil 250kbps && '
           '/sbin/tc class add dev h1-eth0 parent 1:1 classid 1:11 htb rate 10kbps ceil 10kbps && '
           '/sbin/tc class add dev h1-eth0 parent 1:1 classid 1:12 htb rate 240kbps ceil 240kbps && '
           '/sbin/tc qdisc add dev h1-eth0 parent 1:11 handle 11:0 prio bands 5 && '
           '/sbin/tc qdisc add dev h1-eth0 parent 1:12 handle 12:0 prio bands 5 && '
           '/sbin/tc qdisc add dev h1-eth0 parent 11:1 handle 111: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 11:2 handle 112: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 11:3 handle 113: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 11:4 handle 114: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 11:5 handle 115: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 12:1 handle 121: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 12:2 handle 122: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 12:3 handle 123: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 12:4 handle 124: pfifo && '
           '/sbin/tc qdisc add dev h1-eth0 parent 12:5 handle 125: pfifo && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 1:1 prio 1 u32 match ip dst 192.168.0.2 flowid 1:11 && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 1:1 prio 1 u32 match ip dst 192.168.0.3 flowid 1:12 &&'
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 11:0 prio 1 u32 match ip dst 192.168.0.2 ip tos 0x78 0xff flowid 111: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 11:0 prio 1 u32 match ip dst 192.168.0.2 ip tos 0x58 0xff flowid 112: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 11:0 prio 1 u32 match ip dst 192.168.0.2 ip tos 0x40 0xff flowid 113: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 11:0 prio 1 u32 match ip dst 192.168.0.2 ip tos 0x38 0xff flowid 114: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 11:0 prio 1 u32 match ip dst 192.168.0.2 ip tos 0x00 0xff flowid 115: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 12:0 prio 1 u32 match ip dst 192.168.0.3 ip tos 0x78 0xff flowid 121: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 12:0 prio 1 u32 match ip dst 192.168.0.3 ip tos 0x58 0xff flowid 122: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 12:0 prio 1 u32 match ip dst 192.168.0.3 ip tos 0x40 0xff flowid 123: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 12:0 prio 1 u32 match ip dst 192.168.0.3 ip tos 0x38 0xff flowid 124: && '
           '/sbin/tc filter add dev h1-eth0 protocol ip parent 12:0 prio 1 u32 match ip dst 192.168.0.3 ip tos 0x00 0xff flowid 125:')
