...
def myNet():
    ...
    r1.cmd('/sbin/tc qdisc add dev r1-eth3 root handle 1: htb default 1 && '
           '/sbin/tc class add dev r1-eth3 parent 1: classid 1:1 htb rate 512kbit ceil 512kbit burst 512kb && '
    ...
    s1.cmd('/sbin/tc class change dev s1-eth2 parent 1: classid 1:11 htb rate 0.6kbit')
    s1.cmd('/sbin/tc class change dev s1-eth2 parent 1: classid 1:12 htb rate 15kbit')
    s1.cmd('/sbin/tc class change dev s1-eth2 parent 1: classid 1:13 htb rate 32kbit')
