...
gg <- gg + facet_grid( factor(shaping, levels=c('With Shaping','Without Shaping')) ~ factor(data_rate, levels=c('0.6 kbps','1.2 kbps','2.4 kbps','4.8 kbps','9.6 kbps')), scales = "free")
