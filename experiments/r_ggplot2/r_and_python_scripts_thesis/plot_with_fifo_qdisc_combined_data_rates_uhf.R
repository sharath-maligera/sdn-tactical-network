...
ggsave(filename = "C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/plots/with_ets_qdisc_no_timeout_uhf.png",plot=last_plot(), device="png", units = "mm", width = 400, height = 200, dpi = 600)
#ggsave(filename = "C:/Users/Sharath/PycharmProjects/mininet-wifi/sdn-tactical-network/experiments/r_ggplot2/thesis_plots/host_h3_ets_with_wo_shaping.eps",plot=last_plot(), device="eps", units = "mm", width = 400, height = 220, dpi = 600)
